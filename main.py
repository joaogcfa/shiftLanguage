...
class Tokenizer:
    ...
    def selectNext(self):
        ...
        elif self.origin[self.position] == 'O':
            self.position += 1
            self.actual = Token('O', "OR")
            return self.actual

        elif self.origin[self.position] == 'A':
            self.position += 1
            self.actual = Token('A', "AND")
            return self.actual

        elif self.origin[self.position] == 'N':
            self.position += 1
            self.actual = Token('N', "NOT")
            return self.actual
